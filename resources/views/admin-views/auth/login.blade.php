    ...
    <main id="content">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col md 6">
                    <img src="{{ asset('assets/admin/img/update2.png') }}" style="margin-top: 90px;" />
                </div>
                <div class="col md 6">
                    <div class="">
                        ...
                        <div class="auth-wrapper-right">
                            ...
                            <div class="auth-wrapper-form">
                                <!-- Form -->
                                <form class="" id="form-id" action="{{ route('admin.auth.login') }}"
                                    method="post">
                                    @csrf
                                    <div class="auth-header">
                                        <div class="mb-5">
                                            ...
                                            <p class="mb-0 text-capitalize">
                                                {{ translate('want_to_login_your_branches') }}?
                                                <a
                                                    href="{{ route('branch.auth.login') }}">{{ translate('branch_login') }}</a>
                                            </p>
                                            <span class="badge mt-2">( {{ translate('admin_or_employee_sign_in') }}
                                                )</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="js-form-message form-group">
                                        <label class="input-label text-capitalize"
                                            for="signinSrEmail">{{ translate('your') }}
                                            {{ translate('email') }}</label>

                                        <input type="email" class="form-control form-control-lg" name="email"
                                            id="signinSrEmail" tabindex="1"
                                            placeholder="{{ translate('email@address.com') }}"
