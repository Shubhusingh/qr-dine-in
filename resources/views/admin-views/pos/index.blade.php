...
@section('content')
    ...
    <div class="content">
        ...
        <!-- ========================= SECTION CONTENT ========================= -->
        <section class="section-content padding-y-sm bg-default d-flex">
              <div class="col-lg-5">
            ...
            <div class="container-fluid" style="margin-inline-end: -35.4375rem;">
                <div class="col-lg-29">
                            ...
                            <div class="row pl-2">
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="f_name" class="form-control" value="" placeholder="First name" >
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="l_name" class="form-control" value="" placeholder="Last name" >
                                    </div>
                                </div>
                            </div>
                            <div class="row pl-2">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone" class="form-control" value="" placeholder="{{translate('Ex : 9226*****')}}" >
                                    </div>
                                </div>
                            </div>
